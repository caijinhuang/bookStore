					...
					<td style="padding:30px">
						...
						<table width="80%" border="0" cellspacing="2" class="upline">
							<tr>
								...
								<td style="width:50%"><input type="text" class="inputtext" name="cheackID"/></td>
								<td>&nbsp;</td>
							</tr>
							<tr>
								<td style="text-align:right;width:20%;">&nbsp;</td>
								<td colspan="2" style="width:50%"><img
									src="${pageContext.request.contextPath}/CheckServlet" width="150"
									height="30" class="textinput" style="height:30px;width:143px;margin-left: 0px" id="img" />&nbsp;&nbsp;
